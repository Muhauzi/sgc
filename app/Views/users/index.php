...
<div class="main container-fluid px-0">
    ...
    <div class="row">
        <!-- Sidebar -->
        <div class="sidebar d-flex flex-column align-items-stretch flex-shrink-0 col-lg-2 p-0 bg-body-tertiary">
            <!-- Card Header -->
        ...
        <!-- Content -->
        <main class="ms-sm-auto col-lg-8 px-md-4">
            <div class="content d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                <div class="col-lg-5">
                    <div class="row">
